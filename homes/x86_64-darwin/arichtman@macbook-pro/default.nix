...
in
{
  ...
  snowfallorg.user.arichtman.home.config.home.file."_homes_x86_64-darwin_arichtman@macbook-pro_default.nix".text = "";
  home = {
    stateVersion = "22.11";
    ...
    file."_homes_x86_64-darwin_arichtman@macbook-pro_default.nix".text = "";
